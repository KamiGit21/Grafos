...
:global(body) {
  background-image: url('https://i.pinimg.com/originals/08/7b/fb/087bfb3a72c8f5af8a14c7b20352dafd.gif');
...
.light-theme { background-color: rgba(247, 243, 240, 0.9); color: #333; }
.light-theme .toolbar-top { background-color: rgba(253, 246, 236, 0.85); border-bottom-color: #e0c9b6; }
.light-theme .toolbar-top nav button { border-color: #e0c9b6; background-color: #fff9f2; color: #333; }
.light-theme .toolbar-top nav button:hover { background-color: #f3e8dd; }
.light-theme .toolbar-top nav button.active { background-color: #e0c9b6; border-color: #c9b4a4; }
...
.dark-theme { background-color: rgba(44, 44, 44, 0.9); color: #e0e0e0; }
.dark-theme .toolbar-top { background-color: rgba(60, 60, 60, 0.85); border-bottom-color: #555; }
.dark-theme .toolbar-top h1 { color: #f0f0f0; }
.dark-theme .toolbar-top nav button { border-color: #555; background-color: #444; color: #e0e0e0; }
.dark-theme .toolbar-top nav button:hover { background-color: #555; }
.dark-theme .toolbar-top nav button.active { background-color: #555; border-color: #666; }
